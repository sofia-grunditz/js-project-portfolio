const Thoughts = () => {
  return (
    <section className="thoughts">
      <h2 className="pink-title">My thoughts</h2>
      <img src="/images/imagethoughts.png" alt="Glass" className="thoughts-image" />
      <h3 className="subheader">Building Worlds with Words</h3>
      <p className="thoughts-description">In my current role as a technical writer, I create configuration guides, system administration documentation, and technical tutorials that help users understand and navigate complex systems. I enjoy digging into technical details and turning them into content that’s clear, structured, and actually helpful—whether it's for IT pros or curious beginners.
